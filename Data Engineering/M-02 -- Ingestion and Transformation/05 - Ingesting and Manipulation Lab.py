...
## TODO
spark.sql(f'''SELECT * 
FROM csv.`/Volumes/dbacademy/ingestion_lab/taxi_files`
limit 10 ''').display()
...
# MAGIC
# MAGIC create table if not exists dbacademy.ingestion_lab.taxitrips_bronze (
# MAGIC     tpep_pickup_datetime TIMESTAMP,
# MAGIC     tpep_dropoff_datetime TIMESTAMP,
# MAGIC     trip_distance DOUBLE,
# MAGIC     fare_amount DOUBLE,
...
# MAGIC %sql
# MAGIC select * from taxitrips_bronze;
...
# MAGIC %sql
# MAGIC -- TODO
# MAGIC copy into dbacademy.ingestion_lab.taxitrips_bronze
...
# MAGIC FROM dbacademy.ingestion_lab.taxitrips_bronze;
...
# MAGIC %sql
# MAGIC -- TODO
# MAGIC select count(*) from dbacademy.ingestion_lab.taxitrips_bronze;
...
# MAGIC %sql
# MAGIC -- TODO
# MAGIC restore table dbacademy.ingestion_lab.taxitrips_bronze to version as of 1;
...
# MAGIC %sql
# MAGIC -- TODO
# MAGIC describe history dbacademy.ingestion_lab.taxitrips_bronze;
